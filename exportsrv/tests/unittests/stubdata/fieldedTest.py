...
%R 2017SenIm..18...17Z
%T A Microwave Free-Space Method Using Artificial Lens with Anti-reflection Layer
%A Zhang, Yangjun;Aratani, Yuki;Nakazima, Hironari
%F AA(Department of Electronics and Informatics, Ryukoku University),
AB(Department of Electronics and Informatics, Ryukoku University),
AC(Department of Electronics and Informatics, Ryukoku University)
...
poor gas or outflow of metal enriched gas.
...
maximum phase of the Eclipse, while another give the reddened Moon.


%R 2016iac..talk..872V
%T Living on the edge: Adaptive Optics+Lucky Imaging
%A Velasco, Sergio
%F AA(Instituto de Astrof\\u00edsica de Canarias)
...
Alexander J.;Cade-Menun, Barbara J.;Davis, Ronald W.;Du, Lin-Shu;Garcia,
K. Christopher;Herschlag, Daniel;Khosla, Chaitan;Kraut, Daniel A.;Li,
Qing;Null, Brian;Puglisi, Joseph D.;Sigala, Paul A.;Stebbins, Jonathan
F.;Varani, Luca
...
%A Mahabal, Ashish A.;Drake, A. J.;Djorgovski, S. G.;Donalek,
C.;Glikman, E.;Graham, M. J.;Williams, R.;Baltay, C.;Rabinowitz, D.;PQ
...
%R 2000astro.ph..3081G
%T Galactic Worm 123.4-1.5: A Mushroom-shaped HI Cloud
%A Galactic Plane Survey, Canadian;:;English, Jayanne;Taylor, A.
Russ;Mashchenko, Sergey Y.;Irwin, Judith A.;Basu, Shantanu;Johnstone,
Doug
...
survivability and performance (accuracy).
...
%A Aratani, Yuki
%A Nakazima, Hironari
%+ AA(Department of Electronics and Informatics, Ryukoku University), AB(Department of Electronics and Informatics, Ryukoku University), AC(Department of Electronics and Informatics, Ryukoku University)
%B Sensing and Imaging
%V 18
%D 2017
%8 December 01, 2017
%K Free-space method; Artificial material; Anti-reflection layer;
Attenuation; Phase shift
%U https://ui.adsabs.harvard.edu/#abs/2017SenIm..18...17Z
%X This paper describes a microwave free-space method using flat artificial
lens antennas with anti-reflection layer. The lens antenna is made of an
artificial material of metal particle. Comparing with our previous
study, Anti-reflection (AR) layers are supplemented to the lens in this
study to obtain a wave matching on the air-lens interface. The improved
...
supernova remnant; supernovae; white dwarfs
%U https://ui.adsabs.harvard.edu/#abs/2017nova.pres.2388K
%X The outlined regions mark the 57 knots in Tycho selected by the authors
for velocity measurements. Magenta regions have redshifted line-of-sight
velocities (moving away from us); cyan regions have blueshifted light-
of-sight velocities (moving toward us). [Williams et al. 2017]The Tycho
supernova remnant was first observed in the year 1572. Nearly 450 years
...
%K galaxies: evolution; galaxies: abundances; galaxies: ISM
%U https://ui.adsabs.harvard.edu/#abs/2017PhDT........14C
%X Chapter 2: As part of the Bluedisk survey we analyse the radial gas-
phase metallicity profiles of 50 late-type galaxies. We compare the
metallicity profiles of a sample of HI-rich galaxies against a control
sample of HI-'normal' galaxies. We find the metallicity gradient of a
galaxy to be strongly correlated with its HI mass fraction {M}{HI}) /
...
individual (V694 Mon; MWC 560)
%U https://ui.adsabs.harvard.edu/#abs/2017AAVSN.429....1W
%X The observing campaign from 2016 on V694 Mon (MWC 560) (AAVSO Alert
Notice 538) has been continued, but with different requirements.
Photometry is no longer specifically requested on a regular basis
(although ongoing observations that do not interfere with other
obligations are welcome). Spectroscopy on a cadence of a week or two is
...
%8 April 01, 2017
%U https://ui.adsabs.harvard.edu/#abs/2017sptz.prop13168Y
%X ULIRG F01004-2237 had a strong optical flare, peaked in 2010, and the
follow-up optical spectra classified this event as a TDE candidate
(Tadhunter et al. 2017, Nature Astronomy). In early 2017, using archival
WISE data, we discovered that its 3.4 and 4.6um fluxes have been
steadily rising since 2013, increased by a factor of 3.5 and 2.6
...
%8 March 01, 2017
%U https://ui.adsabs.harvard.edu/#abs/2017MsT..........2A
%X The African Very-long-baseline interferometry Network (AVN) is a joint
project between South Africa and eight partner African countries aimed
at establishing a VLBI (Very-Long-Baseline Interferometry) capable
network of radio telescopes across the African continent. An existing
structure that is earmarked for this project, is a 32 m diameter antenna
...
%K THE MOON; ECLIPSES; PARTIAL; PENUMBRAL; ASTROPHOTOGRAPHY
%U https://ui.adsabs.harvard.edu/#abs/2016emo6.rept.....R
%X The web page represents circumstances and photographs from the Moon's
partial/penumbral eclipse from 16 September 2016 obtained from few
various places in Romania (East Europe). A part of photographs give the
maximum phase of the Eclipse, while another give the reddened Moon.
...
%T Living on the edge: Adaptive Optics+Lucky Imaging
%A Velasco, Sergio
%+ AA(Instituto de Astrof\\u00edsica de Canarias)
...
%K Physics
%U https://ui.adsabs.harvard.edu/#abs/2009bcet.book...65L
%X The discovery of the physical phenomenon of Nuclear Magnetic Resonance
(NMR) in 1946 gave rise to the spectroscopic technique that has become a
remarkably versatile research tool. One could oversimplify NMR spectros-
copy by categorizing it into the two broad applications of structure
elucidation of molecules (associated with chemistry and biology) and
...
%A Indiana
%A , . . .
%+ AA(Caltech), AB(Caltech), AC(Caltech), AD(Caltech), AE(Caltech), AF(Caltech), AG(Caltech), AH(Yale University), AI(Yale University), AJ(-), AK(-), AL(-), AM(-), AN(-)
%B American Astronomical Society Meeting Abstracts #210
%V 210
%D 2007
%8 May 01, 2007
%U https://ui.adsabs.harvard.edu/#abs/2007AAS...210.2104M
%X Palomar-QUEST (PQ) synoptic sky survey has now been routinely processing
data from driftscans in real-time. As four photometric bandpasses are
utilized in nearly simultaneously, PQ is well suited to search for
transient and highly variable objects. Using a series of software
filters i.e. programs to select/deselect objects based on certain
...
%8 January 01, 2007
%U https://ui.adsabs.harvard.edu/#abs/2007RJPh....1...35.
%3 10.3923/rjp.2007.35.41


%0 Electronic Article
%T Galactic Worm 123.4-1.5: A Mushroom-shaped HI Cloud
%A Galactic Plane Survey, Canadian
%A :
%A English, Jayanne
%A Taylor, A. Russ
%A Mashchenko, Sergey Y.
%A Irwin, Judith A.
%A Basu, Shantanu
%A Johnstone, Doug
...
%K Astrophysics
%U https://ui.adsabs.harvard.edu/#abs/2000astro.ph..3081G
%X The Dominion Radio Astrophysical Observatory's Synthesis Telescope
provides the highest resolution data (1 arcmin and 0.82 km/s) to date of
an HI worm candidate. Observed as part of the Canadian Galactic Plane
Survey, mushroom-shaped GW 123.4-1.5 extends only a few hundred parsecs,
contains ~10^5 solar masses of neutral hydrogen, and appears unrelated
...
Spacecraft Communications, Command and Tracking
%U https://ui.adsabs.harvard.edu/#abs/1995ans..agar..390M
%X Spacecraft operation depends upon knowledge of vehicular position and,
consequently, navigational support has been required for all such
systems. Technical requirements for different mission trajectories and
orbits are addressed with consideration given to the various tradeoffs
which may need to be considered. The broad spectrum of spacecraft are
...
Communications, Spacecraft Communications, Command and Tracking
%U https://ui.adsabs.harvard.edu/#abs/1983aiaa.meetY....K
%X The concept of using lunar beacon signal transmission for on-board
navigation for earth satellites and near-earth spacecraft is described.
The system would require powerful transmitters on the earth-side of the
moon's surface and black box receivers with antennae and microprocessors
placed on board spacecraft for autonomous navigation. Spacecraft
...
TY  - Journal
T1  - A Microwave Free-Space Method Using Artificial Lens with Anti-reflection Layer
A1  - Zhang, Yangjun
A1  - Aratani, Yuki
A1  - Nakazima, Hironari
JO  - Sensing and Imaging
VL  - 18
Y1  - 2017/12/1
SP  - 17
KW  - Free-space method/ Artificial material/ Anti-reflection layer/
Attenuation/ Phase shift
UR  - https://ui.adsabs.harvard.edu/#abs/2017SenIm..18...17Z
N2  - This paper describes a microwave free-space method using flat artificial
lens antennas with anti-reflection layer. The lens antenna is made of an
artificial material of metal particle. Comparing with our previous
study, Anti-reflection (AR) layers are supplemented to the lens in this
study to obtain a wave matching on the air-lens interface. The improved
...
N2  - The outlined regions mark the 57 knots in Tycho selected by the authors
for velocity measurements. Magenta regions have redshifted line-of-sight
velocities (moving away from us); cyan regions have blueshifted light-
of-sight velocities (moving toward us). [Williams et al. 2017]The Tycho
supernova remnant was first observed in the year 1572. Nearly 450 years
...
N2  - Chapter 2: As part of the Bluedisk survey we analyse the radial gas-
phase metallicity profiles of 50 late-type galaxies. We compare the
metallicity profiles of a sample of HI-rich galaxies against a control
sample of HI-'normal' galaxies. We find the metallicity gradient of a
galaxy to be strongly correlated with its HI mass fraction {M}{HI}) /
...
N2  - The observing campaign from 2016 on V694 Mon (MWC 560) (AAVSO Alert
Notice 538) has been continued, but with different requirements.
Photometry is no longer specifically requested on a regular basis
(although ongoing observations that do not interfere with other
obligations are welcome). Spectroscopy on a cadence of a week or two is
...
N2  - ULIRG F01004-2237 had a strong optical flare, peaked in 2010, and the
follow-up optical spectra classified this event as a TDE candidate
(Tadhunter et al. 2017, Nature Astronomy). In early 2017, using archival
WISE data, we discovered that its 3.4 and 4.6um fluxes have been
steadily rising since 2013, increased by a factor of 3.5 and 2.6
...
N2  - The African Very-long-baseline interferometry Network (AVN) is a joint
project between South Africa and eight partner African countries aimed
at establishing a VLBI (Very-Long-Baseline Interferometry) capable
network of radio telescopes across the African continent. An existing
structure that is earmarked for this project, is a 32 m diameter antenna
...
N2  - The web page represents circumstances and photographs from the Moon's
partial/penumbral eclipse from 16 September 2016 obtained from few
various places in Romania (East Europe). A part of photographs give the
maximum phase of the Eclipse, while another give the reddened Moon.
ER  -  
...
N2  - The discovery of the physical phenomenon of Nuclear Magnetic Resonance
(NMR) in 1946 gave rise to the spectroscopic technique that has become a
remarkably versatile research tool. One could oversimplify NMR spectros-
copy by categorizing it into the two broad applications of structure
elucidation of molecules (associated with chemistry and biology) and
...
N2  - Palomar-QUEST (PQ) synoptic sky survey has now been routinely processing
data from driftscans in real-time. As four photometric bandpasses are
utilized in nearly simultaneously, PQ is well suited to search for
transient and highly variable objects. Using a series of software
filters i.e. programs to select/deselect objects based on certain
...
TY  - Preprint
T1  - Galactic Worm 123.4-1.5: A Mushroom-shaped HI Cloud
A1  - Galactic Plane Survey, Canadian
A1  - :
A1  - English, Jayanne
A1  - Taylor, A. Russ
A1  - Mashchenko, Sergey Y.
A1  - Irwin, Judith A.
A1  - Basu, Shantanu
A1  - Johnstone, Doug
JO  - ArXiv e-prints
...
SP  - astro-ph/0003081
KW  - Astrophysics
UR  - https://ui.adsabs.harvard.edu/#abs/2000astro.ph..3081G
N2  - The Dominion Radio Astrophysical Observatory's Synthesis Telescope
provides the highest resolution data (1 arcmin and 0.82 km/s) to date of
an HI worm candidate. Observed as part of the Canadian Galactic Plane
Survey, mushroom-shaped GW 123.4-1.5 extends only a few hundred parsecs,
contains ~10^5 solar masses of neutral hydrogen, and appears unrelated
...
N2  - Spacecraft operation depends upon knowledge of vehicular position and,
consequently, navigational support has been required for all such
systems. Technical requirements for different mission trajectories and
orbits are addressed with consideration given to the various tradeoffs
which may need to be considered. The broad spectrum of spacecraft are
...
N2  - The concept of using lunar beacon signal transmission for on-board
navigation for earth satellites and near-earth spacecraft is described.
The system would require powerful transmitters on the earth-side of the
moon's surface and black box receivers with antennae and microprocessors
placed on board spacecraft for autonomous navigation. Spacecraft
...
KW  - Artificial material
KW  - Anti-reflection layer
KW  - Attenuation
KW  - Phase shift
UR  - https://ui.adsabs.harvard.edu/#abs/2017SenIm..18...17Z
N2  - This paper describes a microwave free-space method using flat artificial
...
A1 Aratani, Yuki
A1 Nakazima, Hironari
AD AA(Department of Electronics and Informatics, Ryukoku University), AB(Department of Electronics and Informatics, Ryukoku University), AC(Department of Electronics and Informatics, Ryukoku University)
JF Sensing and Imaging
VO 18
YR 2017
FD 2017/12/1
SP 17
K1 Free-space method
K1 Artificial material
K1 Anti-reflection layer
K1 Attenuation
K1 Phase shift
LK https://ui.adsabs.harvard.edu/#abs/2017SenIm..18...17Z
AB This paper describes a microwave free-space method using flat artificial
lens antennas with anti-reflection layer. The lens antenna is made of an
artificial material of metal particle. Comparing with our previous
study, Anti-reflection (AR) layers are supplemented to the lens in this
study to obtain a wave matching on the air-lens interface. The improved
...
very small in the size. It is possible to construct a very compact and
low cost free-space setup using the improved lens.
DO DOI: 10.1007/s11220-017-0166-7
...
AB The outlined regions mark the 57 knots in Tycho selected by the authors
for velocity measurements. Magenta regions have redshifted line-of-sight
velocities (moving away from us); cyan regions have blueshifted light-
of-sight velocities (moving toward us). [Williams et al. 2017]The Tycho
supernova remnant was first observed in the year 1572. Nearly 450 years
...
AB Chapter 2: As part of the Bluedisk survey we analyse the radial gas-
phase metallicity profiles of 50 late-type galaxies. We compare the
metallicity profiles of a sample of HI-rich galaxies against a control
sample of HI-'normal' galaxies. We find the metallicity gradient of a
galaxy to be strongly correlated with its HI mass fraction {M}{HI}) /
...
AB The observing campaign from 2016 on V694 Mon (MWC 560) (AAVSO Alert
Notice 538) has been continued, but with different requirements.
Photometry is no longer specifically requested on a regular basis
(although ongoing observations that do not interfere with other
obligations are welcome). Spectroscopy on a cadence of a week or two is
...
AB ULIRG F01004-2237 had a strong optical flare, peaked in 2010, and the
follow-up optical spectra classified this event as a TDE candidate
(Tadhunter et al. 2017, Nature Astronomy). In early 2017, using archival
WISE data, we discovered that its 3.4 and 4.6um fluxes have been
steadily rising since 2013, increased by a factor of 3.5 and 2.6
...
AB The African Very-long-baseline interferometry Network (AVN) is a joint
project between South Africa and eight partner African countries aimed
at establishing a VLBI (Very-Long-Baseline Interferometry) capable
network of radio telescopes across the African continent. An existing
structure that is earmarked for this project, is a 32 m diameter antenna
...
AB The web page represents circumstances and photographs from the Moon's
partial/penumbral eclipse from 16 September 2016 obtained from few
various places in Romania (East Europe). A part of photographs give the
maximum phase of the Eclipse, while another give the reddened Moon.
...
T1 Living on the edge: Adaptive Optics+Lucky Imaging
A1 Velasco, Sergio
AD AA(Instituto de Astrof\\u00edsica de Canarias)
...
AB The discovery of the physical phenomenon of Nuclear Magnetic Resonance
(NMR) in 1946 gave rise to the spectroscopic technique that has become a
remarkably versatile research tool. One could oversimplify NMR spectros-
copy by categorizing it into the two broad applications of structure
elucidation of molecules (associated with chemistry and biology) and
...
A1 Indiana
A1 , . . .
AD AA(Caltech), AB(Caltech), AC(Caltech), AD(Caltech), AE(Caltech), AF(Caltech), AG(Caltech), AH(Yale University), AI(Yale University), AJ(-), AK(-), AL(-), AM(-), AN(-)
...
AB Palomar-QUEST (PQ) synoptic sky survey has now been routinely processing
data from driftscans in real-time. As four photometric bandpasses are
utilized in nearly simultaneously, PQ is well suited to search for
transient and highly variable objects. Using a series of software
filters i.e. programs to select/deselect objects based on certain
...
SP astro-ph/0003081
K1 Astrophysics
LK https://ui.adsabs.harvard.edu/#abs/2000astro.ph..3081G
AB The Dominion Radio Astrophysical Observatory's Synthesis Telescope
provides the highest resolution data (1 arcmin and 0.82 km/s) to date of
an HI worm candidate. Observed as part of the Canadian Galactic Plane
Survey, mushroom-shaped GW 123.4-1.5 extends only a few hundred parsecs,
contains ~10^5 solar masses of neutral hydrogen, and appears unrelated
...
AB Spacecraft operation depends upon knowledge of vehicular position and,
consequently, navigational support has been required for all such
systems. Technical requirements for different mission trajectories and
orbits are addressed with consideration given to the various tradeoffs
which may need to be considered. The broad spectrum of spacecraft are
...
AB The concept of using lunar beacon signal transmission for on-board
navigation for earth satellites and near-earth spacecraft is described.
The system would require powerful transmitters on the earth-side of the
moon's surface and black box receivers with antennae and microprocessors
placed on board spacecraft for autonomous navigation. Spacecraft
...
PT  - Journal Article
TI  - A Microwave Free-Space Method Using Artificial Lens with Anti-reflection Layer
AU  - Zhang, Yangjun
AU  - Aratani, Yuki
...
SO  - IAC Talks, Astronomy and Astrophysics Seminars from the Instituto de Astrof&iacute;sica de Canarias, 872
DP  - 2016 Mar 01
...
AU  - Varani, Luca
TA  - Biophysics and the Challenges of Emerging Threats
...
PT  - Preprint
TI  - Galactic Worm 123.4-1.5: A Mushroom-shaped HI Cloud
AU  - Galactic Plane Survey, Canadian
AU  - :
AU  - English, Jayanne
AU  - Taylor, A. Russ
AU  - Mashchenko, Sergey Y.
AU  - Irwin, Judith A.
AU  - Basu, Shantanu
AU  - Johnstone, Doug
TA  - ArXiv e-prints
SO  - eprint arXiv:astro-ph/0003081
DP  - 2000 Mar 01
4099- https://ui.adsabs.harvard.edu/#abs/2000astro.ph..3081G
AB  - The Dominion Radio Astrophysical Observatory's Synthesis Telescope
provides the highest resolution data (1 arcmin and 0.82 km/s) to date of
an HI worm candidate. Observed as part of the Canadian Galactic Plane
Survey, mushroom-shaped GW 123.4-1.5 extends only a few hundred parsecs,
...
AU  - Yunck, T.
AU  - Wu, S.
TA  - AIAA, Aerospace Sciences Meeting
